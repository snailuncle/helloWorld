    ...
    w = floaty.window(
        <frame id="背景1"  w="210" h="120" margin="0" gravity="center"  bg="#8833ff00">
         <vertical gravity="right">
           ...
           <button id="退出" margin="-4" gravity="center" text="退出"  w="200" h="30" textSize="8sp" />
              </linear>
          <linear gravity="center">
...
// ================================================================================================
    w.截图.click(() => {
        ...
        // aa = images.clip(img, 截图[0], 截图[1], Math.abs(截图[2] - 截图[0]), Math.abs(截图[3] - 截图[1]))
...
function 上坐标() {
    w1 = floaty.window(
        <frame id="移动11" gravity="center" bg="#0000ff">
        <vertical>
...
function 下坐标() {
    w2 = floaty.window(
        <frame id="移动22" margin="0" padding="0" gravity="right|bottom" bg="#00ff00">
    ...
    w2.移动22.setOnTouchListener(function(view, event) {
        switch (event.getAction()) {
            case event.ACTION_DOWN:
                ...
                log("触摸的点距离自身左边界的距离",windowX,windowY)
