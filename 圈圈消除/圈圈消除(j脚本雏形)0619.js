...
//这个脚本可以战胜大部分人,但还是有一点bug,连胜是没有问题的.
auto();
//请求截图
...
while(1){
    ...
    for(let i=0;i<3;i++){
        ...
        if(appropriatePut==false){
            ...
            // 这里不应该随机放,而应该放到颜色相同的一列或者一横或者斜线上的位置
            ...
            //log("本次找到了圈圈最适合颜色的安放位置")
            //log(sequenceNumber3,"圈圈这次放到",appropriatePut,"号位置")
            putCircle(sequenceNumber3,appropriatePut)
            sleep(放置后的间隔时间)
